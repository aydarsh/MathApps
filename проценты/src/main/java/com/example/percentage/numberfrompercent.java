...
public class numberfrompercent extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_numberfrompercent);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btnFind:
                ...
                BigDecimal result = num1.divide(num2.multiply(new BigDecimal("0.01")), 10, RoundingMode.HALF_UP);
                ...
                strExercise = String.format("%s это %s%%. \n%s = %s%% * x; \nx = %s : %s = %s",
                        strNum1, strNum2, strNum1, strNum2, strNum1, strNum2dividedBy100, strResult);
