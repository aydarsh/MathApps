...
public class percentdecrease extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_percentdecrease);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btnFind:
                ...
                String strDecrease = formatter.format((new BigDecimal("100")).subtract(num2).multiply(new BigDecimal("0.01")));
                BigDecimal result = num1.multiply((new BigDecimal("100")).subtract(num2)).multiply(new BigDecimal("0.01"));
                ...
                strExercise = String.format("%s - %s%%. \nx = %s * (1 - %s) = %s * %s = %s",
                        strNum1, strNum2, strNum1, strNum2dividedBy100, strNum1, strDecrease, strResult);
