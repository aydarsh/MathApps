...
public class percentofnumber extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_percentofnumber);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btnFind:
                ...
                BigDecimal result = num1.multiply(num2).multiply(new BigDecimal("0.01"));
